...
<div class="bodywrapper">
    ...
    <div id="main_show" class="centercontent tables">
        <div class="pageheader notab">
            <h1 class="pagetitle">首页 > 菜单列表管理 > 添加/修改菜单</h1>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                ...
                <form class="stdform" action="/admin/menu/modify" method="post" enctype="multipart/form-data">
                    ...
                    <p>
                        ...
                        <small class="desc">菜单列表中的排序位置,请输入数字编号</small>
                    </p>
                    <p>
                        <label>类型编号</label>
                        <span class="field"><input type="text" name="type" value="${model.type!''}" class="smallinput"/></span>
                        <small class="desc">菜单对应的编号,方便APP响应指令(建议与菜单序号一致)</small>
                    </p>
                    <p>
                        <label>菜单图标</label>
