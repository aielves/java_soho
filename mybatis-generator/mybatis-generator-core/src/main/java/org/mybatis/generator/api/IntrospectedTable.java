...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_MYBATIS3_FIND_BY_CND, // 条件查询

        ATTR_MYBATIS3_UPDATE_BY_CND, // 条件更新

        ATTR_MYBATIS3_DELETE_BY_CND, // 条件删除
    ...
    public void setCountByCndId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_COUNT_BY_CND,
                s);
    }

    public void setFindByCndId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_FIND_BY_CND,
                s);
    }

    public void setDeleteByCndId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_DELETE_BY_CND,
                s);
    }

    public void setUpdateByCndId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_UPDATE_BY_CND,
                s);
    }

    public void setFindMapByCndId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_FIND_MAP_BY_CND,
                s);
    }
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            // sb.append(context.getJavaParamConfiguration().getMapperExt()+"Imp.xml"); // 修改mapper文件后缀
        }
        return sb.toString();
    }
    ...
    public String getMyBatis3FindByCnd() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_FIND_BY_CND);
    }

    public void setMyBatis3FindByCnd(String mybatis3FindByCnd) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_FIND_BY_CND,
                mybatis3FindByCnd);
    }

    public String getMyBatis3UpdateByCnd() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_UPDATE_BY_CND);
    }
    ...
    public void setMyBatis3UpdateByCnd(String mybatis3UpdateByCnd) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_UPDATE_BY_CND,
                mybatis3UpdateByCnd);
    }

    public String getMyBatis3DeleteByCnd() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_DELETE_BY_CND);
    }

    public void setMyBatis3DeleteByCnd(String mybatis3DeleteByCnd) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_DELETE_BY_CND,
                mybatis3DeleteByCnd);
    }

    public String getMyBatis3CountByCnd() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_COUNT_BY_CND);
    }

    public void setMyBatis3CountByCnd(String mybatis3CountByCnd) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_COUNT_BY_CND,
                mybatis3CountByCnd);
    }
