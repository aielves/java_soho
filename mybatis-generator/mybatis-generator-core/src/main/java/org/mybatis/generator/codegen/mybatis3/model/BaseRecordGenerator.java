...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        String fullModelPack = context.getJavaParamConfiguration().getBaseModel();
        FullyQualifiedJavaType superface = new FullyQualifiedJavaType(fullModelPack.substring(fullModelPack.lastIndexOf(".") + 1));
        superface.addTypeArgument(new FullyQualifiedJavaType(context.getJavaParamConfiguration().getBaseFXType()));
        topLevelClass.addSuperInterface(superface);
        topLevelClass.addImportedType(new FullyQualifiedJavaType(fullModelPack));
