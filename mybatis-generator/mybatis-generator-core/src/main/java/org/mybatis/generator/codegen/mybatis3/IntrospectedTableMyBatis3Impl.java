...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    public List<GeneratedXmlFile> getGeneratedXmlFiles() {
        ...
        if (xmlMapperGenerator != null) {
            String mapperPackage = getMyBatis3XmlMapperPackage() + context.getJavaParamConfiguration().getDaoMapperPath();

            try {
                Session session = SecurityUtils.getSubject().getSession();
                if (session != null) {
                    DbMessage dbMessage = (DbMessage) session.getAttribute("dbmessage");
                    mapperPackage = dbMessage.getPackageName() + context.getJavaParamConfiguration().getDaoMapperPath();
                }
            } catch (Exception e) {
            }
            ...
            GeneratedXmlFile gxf = new GeneratedXmlFile(document,
                    getMyBatis3XmlMapperFileName(), mapperPackage,
